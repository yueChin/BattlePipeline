    ...
    public static class Game
    {
        ...
        public static Scene Scene
        {
            get
            {
                ...
                scene = EntitySceneFactory.CreateScene(IdGenerator.Instance.GenerateInstanceId(), 0, SceneType.Process, "Process");
                return scene;
            }
        }
        ...
        public static IdGenerator IdGenerator => IdGenerator.Instance;
